> v0.3.0: новое направление «1079 · Высота» по материалам Антона — см. [ТЗ и границы прототипа](docs/ANTON_DIRECTION.md). Выживание и исторический архив выбираются при входе. V — переключить камеру, E — удерживать для розжига у кострища (или нажать кнопку). Для совместной игры нужны одинаковый режим и код комнаты.
