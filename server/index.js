...
app.get('/health',(req,res)=>res.json({ok:true,name:'1079-last-night',version:'0.3.0',commit:process.env.RAILWAY_GIT_COMMIT_SHA||'local'}));
...
server.listen(process.env.PORT||3000,'0.0.0.0',()=>console.log('1079 v0.3.0 listening'));
